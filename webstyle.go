...
{{ end }}`
        ...
        BodyAmpGohtml = `{{ define "BodyAmpGohtml" }}
{{ if .AMP }}
...
{{ end }}`
        ...
        LayoutBlogindexGohtml = `{{ define "LayoutBlogindexGohtml" }}
<!doctype html>
...
{{ end }}`
        ...
        LayoutBlogpostGohtml = `{{ define "LayoutBlogpostGohtml" }}
<!doctype html>
{{ if .AMP }}<html ⚡>{{ else }}<html lang="en">{{ end }}
<head>
        {{ template "head" . }}
...
{{ end }}`
        ...
        LayoutMainGohtml = `{{ define "LayoutMainGohtml" }}
<!doctype html>
{{ if .AMP }}<html ⚡>{{ else }}<html lang="en">{{ end }}
<head>
        {{ template "head" . }}
